...
public class FileUtil {
     ...
     * @return ResponseBo
     */
    public static ResponseResult createExcelByPOIKit(String filename, List<?> list, Class<?> clazz) {

        if (list.isEmpty()) {
            return ResponseResult.warn("导出数据为空！");
        } else {
     ...
     * @return ResponseBo
     */
    public static ResponseResult createCsv(String filename, List<?> list, Class<?> clazz) {
