package com.simple.bets.modular.job.util;
...
public class ScheduleUtils {
     ...
     * 创建定时任务
     */
    public static void createScheduleJob(Scheduler scheduler, JobModel scheduleJob) {
        try {
            // 构建job信息
            ...
            // 放入参数，运行时的方法可以获取
            jobDetail.getJobDataMap().put(JobModel.JOB_PARAM_KEY, scheduleJob);
     ...
     * 更新定时任务
     */
    public static void updateScheduleJob(Scheduler scheduler, JobModel scheduleJob) {
        try {
            ...
            if (trigger == null) {
                ...
                // 参数
                trigger.getJobDataMap().put(JobModel.JOB_PARAM_KEY, scheduleJob);
            }
     ...
     * 立即执行任务
     */
    public static void run(Scheduler scheduler, JobModel scheduleJob) {
        try {
            // 参数
